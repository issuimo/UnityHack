...
namespace unity {
    ...
    inline auto CSharper::SetMap(std::unordered_map<std::string, void*>& map) -> void {
        ...
        if (il2cpp) {
            ...
            methodAddress_["Camera.get_depth"] = Il2cpp::Method::GetAddress("Camera", "get_depth", 0, "UnityEngine");
            methodAddress_["Camera.set_depth"] = Il2cpp::Method::GetAddress("Camera", "set_depth", 1, "UnityEngine");
            methodAddress_["Transform.get_position"] = Il2cpp::Method::GetAddress("Transform",
                                                                                  "get_position",
                                                                                  0,
                                                                                  "UnityEngine");
            methodAddress_["Transform.set_position"] =
                Il2cpp::Method::GetAddress("UnityEngine.Transform", "set_position", 1);
        } else {
        ...
        for (auto& [name, address] : methodAddress_)
            std::cout << name << "|" << std::hex << address << std::endl;
    }
}
